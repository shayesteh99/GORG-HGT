...
for i in {"0","5","10"} $(seq 20 10 90); do
    ...
    python compute_GND_AAD.py simulated_genomes/$g/mutated_BLOSUM62_${g}_a${alpha}\_gnd$(printf "%05d" ${i}) simulated_genomes/$g/$g
done
for i in $(seq 1 1 20); do 
    ...
    python compute_GND_AAD.py simulated_genomes/$g/mutated_BLOSUM62_${g}_a${alpha}\_gnd$(printf "%03d" ${i}) simulated_genomes/$g/$g
done
done
